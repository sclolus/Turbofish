...
static struct program_test TEST_PROGRAMS[] = {
	...
	{.path = "/bin/DeepTests/socket/sockdgram_connect"},
	{.path = "/bin/DeepTests/socket/sockdgram_recvfrom"},
	{.path = "/bin/DeepTests/fchown/fchown_fails_if_not_owner"},
	{.path = "/bin/DeepTests/chown_tests/chown_fails_if_not_owner"},
	{.path = "/bin/DeepTests/fchmod/fchmod_fails_if_not_owner"},
	{.path = "/bin/DeepTests/chmod_tests/chmod_fails_if_not_owner"},
	{.path = "/bin/DeepTests/open/o_trunc"},
	{.path = "/bin/DeepTests/fifo/fifo"},
	{.path = "/bin/DeepTests/execve/bad_elf"},
	{.path = "/bin/DeepTests/unlink/unlink_orphan"},
	{.path = "/bin/DeepTests/link/link"},
	{.path = "/bin/DeepTests/link/link_is_denied_on_unwritable_directory"},
	{.path = "/bin/DeepTests/opendir/opendir_is_denied_on_unreachable"},
	{.path = "/bin/DeepTests/unlink/unlink_is_denied_on_unwritable_directory"},
	{.path = "/bin/DeepTests/unlink/unlink_multiple"},
	{.path = "/bin/DeepTests/unlink/unlink"},
	{.path = "/bin/DeepTests/symlink/symlink_is_denied_on_unwritable_directory"},
	{.path = "/bin/DeepTests/symlink/symlink"},
	{.path = "/bin/DeepTests/open/open_o_creat_is_denied_for_unwritable_parent"},
	{.path = "/bin/DeepTests/open/cannot_open_with_bad_perms"},
	{.path = "/bin/DeepTests/open/open_fails_with_eaccess_basic"},
	{.path = "/bin/DeepTests/rename/rename_dir_not_empty"},
	{.path = "/bin/DeepTests/rename/rename_dir_exist"},
	{.path = "/bin/DeepTests/rename/rename_file_exist"},
	{.path = "/bin/DeepTests/rename/rename"},
	{.path = "/bin/DeepTests/rename/rename_dir"},
	{.path = "/bin/DeepTests/dir/mkdir"},
	{.path = "/bin/DeepTests/dir/mkdir_exist"},
	{.path = "/bin/DeepTests/dir/rmdir_not_empty"},
	{.path = "/bin/DeepTests/write/create_write_read"},
	{.path = "/bin/DeepTests/access/access"},
	{.path = "/bin/DeepTests/signal/SignalSimple"},
	{.path = "/bin/DeepTests/signal/SignalSimpleDuo"},
	{.path = "/bin/DeepTests/ProcessGroup"},
	{.path = "/bin/DeepTests/execve/argv"},
	{.path = "/bin/DeepTests/execve/cannot_exec_directory"},
	{.path = "/bin/DeepTests/wait/wait"},
	{.path = "/bin/DeepTests/wait/wuntraced"},
	{.path = "/bin/DeepTests/mprotect/mprotect"},
	{.path = "/bin/DeepTests/mmap/mmap"},
	{.path = "/bin/DeepTests/atexit/atexit"},
	{.path = "/bin/DeepTests/munmap/munmap"},
	{.path = "/bin/DeepTests/sigprocmask/sigprocmask"},
	{.path = "/bin/DeepTests/isatty/isatty"},
	{.path = "/bin/DeepTests/pipe/pipe_fucker"},
	{.path = "/bin/DeepTests/pipe/pipe_fister"},
	{.path = "/bin/DeepTests/pipe/pipe_lorem_ipsum"},
	{.path = "/bin/DeepTests/math/roundf"},
	{.path = "/bin/DeepTests/math/pow"},
	{.path = "/bin/DeepTests/ctype/longlong"},
	{.path = "/bin/DeepTests/lseek/sda"},
	{.path = "/bin/DeepTests/lseek/lseek_return"},
	{.path = "/bin/DeepTests/dirent/dummy_root"},
	{.path = "/bin/DeepTests/read/read_pulp_fiction"},
	{.path = "/bin/DeepTests/execl/execl"},
	{.path = "/bin/DeepTests/is_str_bullshit/is_str_bullshit"},
	{.path = "/bin/DeepTests/umask/umask"},
	{.path = "/bin/DeepTests/statfs/statfs"},
	{.path = "/bin/DeepTests/fstatfs/fstatfs"},
	{.path = "/bin/DeepTests/statvfs/statvfs"},
	{.path = "/bin/DeepTests/fstatvfs/fstatvfs"},
	{.path = "/bin/DeepTests/chmod_tests/einval_mode"},
	{.path = "/bin/DeepTests/chmod_tests/chmod_normal"},
	{.path = "/bin/DeepTests/fchmod/einval_mode"},
	{.path = "/bin/DeepTests/fchmod/fchmod_normal"},
