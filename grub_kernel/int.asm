...
section .text
    ...
    reloc: use32                               ; by Napalm
        ...
        jmp  word CODE16:REBASE				  ; switch to 16bit selector (16bit protected mode)
    p_mode16: use16
        ...
        jmp  word 0x0000:REBASE      ; finally set cs:ip to enter real-mode
    r_mode16: use16
    ...
    ib: db 0x00
        ...
        mov  cr0, eax                          ; set cr0 to result
        jmp  dword CODE32:REBASE     ; switch to 32bit selector (32bit protected mode)
    p_mode32: use32
