...
pub fn really_lazy_hello_world() {
    ...
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
        SCREEN_MONAD.lock().set_text_color(Color::Red).unwrap();
    }
    print!("E");
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
    ...
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
        SCREEN_MONAD.lock().set_text_color(Color::Yellow).unwrap();
    }
    print!("L");
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
    ...
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
        SCREEN_MONAD.lock().set_text_color(Color::Brown).unwrap();
    }
    print!(" ");
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
        SCREEN_MONAD.lock().set_text_color(Color::Magenta).unwrap();
    }
    print!("W");
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
        SCREEN_MONAD.lock().set_text_color(Color::White).unwrap();
    }
    print!("O");
    unsafe {
        PIT0.sleep(Duration::from_millis(200));
