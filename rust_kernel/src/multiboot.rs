...
pub struct MultibootInfo {
    ...
    /*         +*/
    /*12       |*/
    pub boot_device: u32, // present if flags[1] is set
    /*         +*/
    ...
    /*         +*/
    /* 28 - 40 |*/
    pub syms: [u32; 3], // present if flags[4] or flags[5] is set
    /* 44      |*/ pub mmap_length: u32, // present if flags[6] is set
    /* 48      |*/ pub mmap_addr: u32, // present if flags[6] is set
    /*         +*/
    /* 52      |*/
    pub drives_length: u32, // present if flags[7] is set
    /* 56      |*/ pub drives_addr: u32, // present if flags[7] is set
    /*         +*/
    /* 60      |*/
    pub config_table: u32, // present if flags[8] is set
    /*         +*/
    /* 64      |*/
    pub boot_loader_name: u32, // present if flags[9] is set
    /*         +*/
    /* 68      |*/ pub apm_table: u32, // present if flags[10] is set
    /*         +*/
    /* 72      |*/
    pub vbe_control_info: u32, // present if flags[11] is set
    ...
    /*         +*/
    /* 88      |*/
    pub framebuffer_addr: u64, // present if flags[12] is set
